  ...
  return (
    <Dialog.Root>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed overflow-hidden inset-0 md:inset-outo md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2 md:max-w-[640px] h-md:[60vh] w-full bg-slate-700 md:rounded-md flex flex-col outline-none">
          ...
          <button
            type="button"
            // importate ver porque tem que passar um func e não a execução de uma
